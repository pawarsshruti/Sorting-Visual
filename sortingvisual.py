...
from mergesort_code import merge_sort_helper
from mergesort_code import merge
...
options_frame = Frame(root, width= 700, height=300, bg='yellow')
...
algomenu = ttk.Combobox(options_frame, textvariable=select_algorithm, values=['Bubble Sort', 'Merge Sort','Selection Sort'],width=10)
...
arrsize_Entry = Scale(options_frame, from_=3, to=30, resolution=1, orient=HORIZONTAL, label="Array size")
